...
int main(void)
{
  ...
  init(&hcan2);
  gsense_init(&hcan2, GSENSE_LED_GPIO_Port, GSENSE_LED_Pin);
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : Down_Shift_In_Pin Face_BTN0_In_Pin Face_BTN1_In_Pin Face_BTN4_In_Pin */
  GPIO_InitStruct.Pin = Down_Shift_In_Pin|Face_BTN0_In_Pin|Face_BTN1_In_Pin|Face_BTN4_In_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
